...
class LinotArgParser:
    def __init__(self, subcmd, sub_cmd_parser, default_process):
        ...
        self.add_argument('-h', nargs='*', func=self.print_help, help='show command list')
        self.add_argument('--help', nargs='*', func=self.print_help, help='show command list')

    def add_argument(self, arg_str, *args, **kwargs):
        if 'dest' in kwargs:
        ...
        if 'func' in kwargs:
            ...
            func = None
        self._arg_parser.add_argument(arg_str, *args, **kwargs)
